'''
This Question is taken from:- https://prepinsta.com/tcs-codevita/python-program-for-bank-compare-problem/

Problem Statement:-

Question – : There are two banks – Bank A and Bank B. Their interest rates vary. 
You have received offers from both banks in terms of the annual rate of interest, tenure, and variations of the rate of interest over the entire tenure.
